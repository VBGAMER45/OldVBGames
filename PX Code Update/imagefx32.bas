...
Success = FileExists%(App.Path & "\gray.bmp")
If Success = True Then
Form1.Tiles.Picture = LoadPicture(App.Path & "\gray.bmp")
Exit Sub
End If
PicBox.ScaleMode = 3
For Y = 0 To PicBox.ScaleHeight
Form1.Caption = "Game is Loading this is a one time event! " & Y & "\" & PicBox.ScaleHeight
    ...
    Next X
Next Y
Call SavePicture(Form1.Tiles.Image, App.Path & "\gray.bmp")
End Sub
...
Dim Success As Boolean
Dim opRed As Long, opBlue As Long, opGreen As Long
Success = FileExists%(App.Path & "\invert.bmp")
If Success = True Then
Form1.Tiles.Picture = LoadPicture(App.Path & "\invert.bmp")
Exit Sub
End If
PicBox.ScaleMode = 3

For H = 0 To PicBox.ScaleHeight
Form1.Caption = "Game is Loading this is a one time event! " & H & "\" & PicBox.ScaleHeight
    For W = 0 To PicBox.ScaleWidth
    ...
    Next W
Next H
Call SavePicture(Form1.Tiles.Image, App.Path & "\invert.bmp")
